...
export default function EmailBlastPage() {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      // Include dateRange for SCHEDULE_ANNOUNCEMENT
    ...
    <div>
          ...
          {isLoadingTemplates ? (
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-8 text-center">
              ...
              <p className="text-gray-500 mb-4">
                Set up email templates before sending a blast.
              </p>
              <Link
      ...
      {step === 3 && (
        <div className="space-y-6">
          ...
          {/* Date Range for Schedule Announcement */}
          {selectedTemplate?.slug === 'SCHEDULE_ANNOUNCEMENT' && (
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
              <h4 className="font-medium text-blue-900 mb-3 flex items-center gap-2">
                <span className="text-xl">📅</span>
                Zone-Specific Shift Listings
              </h4>
              <p className="text-sm text-blue-700 mb-4">
                Each recipient will see upcoming shifts with openings in their assigned zone(s).
              </p>
              ...
              <p className="text-xs text-blue-600 mt-2">
                Shifts within this date range will be included in the email
              </p>
            </div>
          )}
